...
!----------------------------------------------------------------------
      ...
      Call Read_apar(inp,'nuclear',nuclear)
...
!-----------------------------------------------------------------------------------
      ...
      Call Read_aarg('atom',atom)
      Call Read_iarg('an',an)
      Call Read_aarg('nuclear',nuclear)
      Call Read_rarg('z',z)
      Call Read_aarg('ion',ion)
      Call Read_iarg('ai',ai)
...
!-----------------------------------------------------------------------------------
      ...
      if(atw.eq.0.d0.and.rms.eq.0.d0)  then
        Call Def_atom(an,atom,atw,rms,conf_AV,conf_LS)
      elseif(atw.eq.0.d0.and.rms.ne.0.d0)  then
        Call Def_atom(an,atom,atw,r1,conf_AV,conf_LS)
      elseif(atw.ne.0.d0.and.rms.eq.0.d0) then
       if(atw.le.90.0)  then
